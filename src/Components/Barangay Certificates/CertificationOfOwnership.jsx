...
const CertificationOfOWnership = ({ title, content }) => {
      ...
      if (result.isConfirmed) {
        ...
        try {
          await axios.post(apiUrl, {
            ...
            email: user.email,
            certificate_type: "Certification of Ownership",
            status: "Pending",
            certificate_details: {
              template: "ownership",
              ...
              property: formData.property === "Other" ? formData.otherProperty : formData.property,
      ...
      {isFormOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <motion.div
            ...
            className="bg-white p-6 rounded-lg shadow-lg w-[90%] max-w-md max-h-[80vh] overflow-y-auto scrollbar-hide" // Added max-h, overflow-y and scrollbar-hide class
          >
            <h2 className="text-xl font-bold mb-4">Request Certificate Of Ownership</h2>
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                <label className="block text-sm font-medium">Type of Property Owned</label>
                <select
                  name="property"
                  className="w-full border rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  ...
                  required
                >
                  <option value="">Select your property owned</option>
                ...
                {formData.property === "Other" && (
                  <input
                    type="text"
                    name="otherProperty"
                    placeholder="Please specify your property"
...
export default CertificationOfOWnership;
