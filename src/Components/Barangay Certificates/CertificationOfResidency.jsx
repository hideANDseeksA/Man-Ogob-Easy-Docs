...
const CertificationOfResidency = ({ title, content }) => {
      ...
      if (result.isConfirmed) {
        ...
        try {
          const response = await axios.post(apiUrl, {
            ...
            email: user.email,
            certificate_type: "Certification of Residency",
            status: "Pending",
            certificate_details: {
              template: "residency",
    ...
    <div className="p-4 border rounded-lg w-[75%] mx-auto mt-10">
      ...
      {isFormOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          ...
          >
            <h2 className="text-xl font-bold mb-4">Request Certification Of Residency</h2>
